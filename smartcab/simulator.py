    ...
    def run(self, tolerance=0.05, n_test=0):
        ...
        if self.log_metrics:
            ...
            if a.learning:
                ...
                for state in a.Q:
                    #f.write("{}\n".format(state))
                    f.write("State: {}, Waypoint: {}, Light: {}, Oncoming: {}, Left: {}\n".format(state, a.statesDict[state]["Waypoint"], a.statesDict[state]["Light"], a.statesDict[state]["Oncoming"], a.statesDict[state]["Left"])) #, a.statesDict[state]["Right"] ))
        ...
        print "\nSimulation ended. . . "
        print "\nQ-Table length: {}".format(len(a.Q.keys()))
